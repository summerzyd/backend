...
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=up_adn_sdk
DB_USERNAME=website
DB_PASSWORD=websiteos
DB_PREFIX=up_
AUTH_TABLE=up_users
...
REDIS_PIKA_TARGET_HOST=127.0.0.1
REDIS_PIKA_TARGET_PORT=6379
...
UPLOAD_FILE_WEB=http://sandbox-adn.biddingos.com/fileserver
...
DAILY_MAIL_ADDRESS=maozhiming@iwalnuts.com;leigh@iwalnuts.com;
