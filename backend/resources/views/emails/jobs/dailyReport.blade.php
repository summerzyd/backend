        ...
        <td style="padding:20px 0 10px; border-bottom:1px solid #CBCBCB; text-align:center;">
            <table  style="padding:0px; border-collapse: collapse; display:inline-block;">
                <tr>
                    ...
                    <td style="vertical-align:middle;">&nbsp;{{$subject['date']}}&nbsp;CPD业务日报&nbsp;(数据截止到{{$subject['limit_date']}})</td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <tr style="height:320px;">
                    <td style="width:580px; border-right:1px dotted #CBCBCB; border-bottom:1px dotted #CBCBCB; vertical-align:top;">
                        <div style="padding:0 20px; position:relative; width:540px;">
                            <h4 style="font-size:14px; margin:15px 0 20px; padding:0px;">当月汇总</h4>
                            <table style="padding: 0px; border-collapse: collapse; width:540px; border-bottom:1px dotted #CBCBCB;">
                                <tr>
                                    <td style="width:33%; padding:0 0 45px; font-size:12px;">
                                        <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$sum_month['sum_revenue']}}</span> 元消耗
                                    </td>
                                    <td style="width:33%; padding:0 0 45px; font-size:12px;">
                                        <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$sum_month['sum_clicks']}}</span> 下载
                                    </td>
                                    <td style="width:33%; padding:0 0 45px; font-size:12px;">
                                        <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$sum_month['price']}}</span> 元/下载
                                    </td>
                                </tr>
                            </table>
                            <h4 style="font-size:14px; margin:15px 0 20px; padding:0px;">昨日情况</h4>
                            <table style="padding: 0px; border-collapse: collapse; width:540px;">
                                <tr>
                                    <td style="width:33%; padding:0 0 45px; font-size:12px;">
                                        <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$yesterday['sum_revenue']}}</span> 元消耗
                                    </td>
                                    <td style="width:33%; padding:0 0 45px; font-size:12px;">
                                        <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$yesterday['sum_clicks']}}</span> 下载
                                    </td>
                                    <td style="width:33%; padding:0 0 45px; font-size:12px;">
                                        <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$yesterday['price']}}</span> 元/下载
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:33%; padding:0 0 45px; font-size:12px;">
                                        <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$yesterday['sum_client']}}</span> 有消耗客户数
                                    </td>
                                    <td style="width:33%; padding:0 0 45px; font-size:12px;">
                                        <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$yesterday['sum_ad']}}</span> 有消耗广告数
                                    </td>
                    ...
                    <td style="text-align:center; vertical-align:top; border-bottom:1px dotted #CBCBCB;">
                        <h4 style="font-size:14px; margin:15px 0; padding:0px;">近7日日均下载
                            <span style="font-size:20px; font-weight:600; color:#ff6600;">{{$chart['avg_clicks']}}万</span>
                            ，日均消耗<span style="font-size:20px; font-weight:600; color:#ff6600;">{{$chart['avg_revenue']}}万</span>
                        </h4>
                    ...
                    <td style="border-bottom:1px dotted #CBCBCB; vertical-align:top; overflow:hidden; position:relative;">
                        ...
                        <table style="padding: 0px; margin: 0 1%; border-collapse: collapse; border:solid #CBCBCB; border-width:1px 0px 0px 1px; font-size:14px;width:98%; font-size:12px; ">
                            <tr style="margin: 0px; text-align:center; background: #f3f3f3;">
                                ...
                                <th style="padding: 2px; border:solid #CBCBCB; border-width:0px 1px 1px 0px; font-weight:500;">当月下载量</th>
                                <th style="padding: 2px; border:solid #CBCBCB; border-width:0px 1px 1px 0px; font-weight:500;">当月消耗金额</th>
